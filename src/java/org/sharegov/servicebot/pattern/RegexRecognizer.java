...
public class RegexRecognizer extends PatternRecognizer
{
	Set<Pair<Integer, Integer>> findAll(String regex, String input)
	{
												 ...
												 String input)
	{
		...
		List<PhrasePattern> all = hg.getAll(graph, hg.type(PhrasePattern.class));
